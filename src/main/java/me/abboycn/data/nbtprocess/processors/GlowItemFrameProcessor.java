...
public final class GlowItemFrameProcessor extends AbstractEntityProcessor {
    private static final String GLOW_ITEM_FRAME_ID = "minecraft:glow_item_frame";
    ...
    public boolean supports(String entityId) {
        return GLOW_ITEM_FRAME_ID.equals(entityId);
    }
}
