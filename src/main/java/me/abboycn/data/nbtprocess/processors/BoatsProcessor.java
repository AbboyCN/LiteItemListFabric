...
public final class BoatsProcessor extends AbstractEntityProcessor {
    private static final TagKey<EntityType<?>> BOATS = TagKey.of(
            RegistryKeys.ENTITY_TYPE,
            Identifier.of("c", "boats")
    );
    ...
    public boolean supports(String entityId) {
        ...
        return Registries.ENTITY_TYPE.get(id).isIn(BOATS);
    }
}
